...
steps {
        ...
        sh 'ssh -i ${keyfile} -o StrictHostKeyChecking=no ubuntu@192.168.160.18 "echo $DOCKERHUB_CREDENTIALS_PSW | docker login -u $DOCKERHUB_CREDENTIALS_USR --password-stdin"'
